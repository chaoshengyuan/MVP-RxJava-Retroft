...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mLoadingView = a.getResourceId(R.styleable.LoadingLayout_loadingView, R.layout.layout_loading);
            mFailedView = a.getResourceId(R.styleable.LoadingLayout_stateView, R.layout.layout_reload);
            mEmptyView = a.getResourceId(R.styleable.LoadingLayout_emptyView, R.layout.layout_empty);
